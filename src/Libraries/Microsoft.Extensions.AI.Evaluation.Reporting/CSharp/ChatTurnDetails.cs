...
/// </param>
/// <param name="usage">Usage details for the chat conversation turn (including input and output token counts).</param>
/// <param name="cacheKey">
    ...
    bool? cacheHit = null)
{
    ...
    /// </summary>
    /// <remarks>
    /// Returns <see langword="null"/> if usage details were not available as part of the model response.
    /// </remarks>
